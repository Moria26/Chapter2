...
public class Exercises1 extends AppCompatActivity {
    ...
    private static final String TAG = "moria";
    ...
    private static final ArrayList<String> eventRecord = new ArrayList<String>();
    ...
    public void resetLifecycleDisplay(View view) {
        ...
        eventRecord.clear();
        eventRecord.add(builder.toString());
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LifecycleDisplay = (TextView) findViewById(R.id.logTextView);
        if(savedInstanceState != null) {
            for(String record: eventRecord) {
